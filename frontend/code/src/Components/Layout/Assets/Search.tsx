  ...
  return (
    <div className="dropdown hover:cursor-pointer hidden  sm:flex sm:items-center absolute w-80 right-52">
      <input
        ...
        type="text"
        placeholder="Search"
        className={`input w-80 h-8 sm:w-full mr-4 sm:h-12 bg-accent text-neutral border border-gray-500 placeholder:text-gray-400`}
      ...
      <ul
        tabIndex={0}
        className={`dropdown-content z-[9999] menu p-2 shadow bg-base-200 rounded-box w-full top-12 ${hidden}`}
      >
