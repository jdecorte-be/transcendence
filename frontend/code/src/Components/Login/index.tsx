...
export const Login = () => {
  ...
  return (
    <>
      <div
        className={`overflow-hidden  flex flex-col items-center justify-center h-screen bg-login bg-luxury bg-no-repeat bg-cover bg-center ${false}`}
      >
        <div className="absolute h-full w-full bg-[var(--black)] opacity-40 z-10"></div>
        <div className="absolute top-[25%] sm:top-[30%] xl:top-[35%] z-50 flex flex-col items-center gap-y-20">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            {process.env.REACT_APP_GITHUB_AUTH_PATH && (
              <Link to={process.env.REACT_APP_GITHUB_AUTH_PATH}>
                <GithubButton />
              </Link>
            )}
          </div>
