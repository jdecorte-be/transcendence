...
FT_CALLBACK_URL=http://localhost:3001/auth/login/42/return
GITHUB_CLIENT_ID=your_github_client_id
GITHUB_CLIENT_SECRET=your_github_client_secret
GITHUB_CALLBACK_URL=http://localhost:3001/auth/login/github/return
```

Frontend env (e.g. .env):

```
REACT_APP_AUTH_PATH=http://localhost:3001/auth/login/42
REACT_APP_GITHUB_AUTH_PATH=http://localhost:3001/auth/login/github
```
