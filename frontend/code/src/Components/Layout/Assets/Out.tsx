        ...
        <Link onClick={() => user.logout()} to={logoutUrl}>
          <div
            className={classNames(
              "h-9 w-9 rounded-xl flex justify-center items-center hover:cursor-pointer hover:bg-error/10 text-base-content/50 hover:text-error transition-all duration-200 hover:scale-110 active:scale-95",
              selected && "bg-error/15 text-error",
              className,
            )}
            {...props}
          >
